...
export function GameCard({ game, onJoin, onDelete, isCreator }: GameCardProps) {
  return (
    <div className="game-card" role="article" aria-label={`Игра ${formatGameName(game.name, game._id)}`} style={{ marginBottom: 0, paddingBottom: "16px" }}>
      <div className="game-info" style={{ marginBottom: 0, paddingBottom: "16px" }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', width: '100%', justifyContent: 'space-between', marginTop: '4px', paddingBottom: "8px" }}>
